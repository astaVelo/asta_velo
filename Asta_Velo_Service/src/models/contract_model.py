...
contract = server.api.model('Contract', {
    ...
    'date_from': fields.Date(required=False, description='Start Date: dd.mm.YY.hh:mm'),
    'date_to': fields.Date(required=False, description='End Date: dd.mm.YY.hh:mm')
})